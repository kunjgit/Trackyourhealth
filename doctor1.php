    ...
    <div class="wrapper">
        ...
        <form action="" method="POST">
            ...
            <table class="tbl-30">
                ...
                <tr>    
                    <td colspan="2">
                        <input type="submit"  name="submit" class="input-field" value="Add Admin" class="btn-secondary"  style="font-family:taglinefont; background-color:lightblue; font-size:18px; margin-top:20px; width:100%; color:black;">
                    </td>
                </tr>
