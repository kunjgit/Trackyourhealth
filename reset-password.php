...
<body style="background-color:black; color:white; margin-left: auto; margin-right: auto; ">
    <div class="wrapper" style="background-color:black; color:white; margin-left: auto; margin-right: auto; ">
        <h2 style="  font-family: logofont;  color:#7ed756; letter-spacing: 0.5mm; text-align:center;">Reset Password</h2>
        <p style="font-family:taglinefont; font-size:0.5cm;">Please fill out this form to reset your password.</p>
